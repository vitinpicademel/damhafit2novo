        ...
        <div className="flex flex-col lg:flex-row gap-12 relative">
            ...
            <div className="relative aspect-[16/9] rounded-2xl overflow-hidden shadow-2xl border-8 border-white">
              ...
              <div className="absolute bottom-6 left-6">
                <a 
                  ...
                  className="bg-white hover:bg-[#00A651] hover:text-white text-[#00A651] px-8 py-4 rounded-full shadow-xl transition-all duration-300 flex items-center space-x-3 transform hover:scale-105"
                >
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-2xl p-8 shadow-lg h-full">
              <h3 className="text-[#4A3418] text-3xl font-display mb-4 italic">
                Localização privilegiada
              </h3>
              <div className="h-0.5 w-24 bg-[#C2B280] mb-10"></div>
